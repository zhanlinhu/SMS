...
public class ExcelUtil {
	...
	public static XSSFWorkbook createExcelFile(Class clazz, List Objectjs,
		...
		createTableRows(sheet, map, Objectjs, clazz); // 创建内容
		return workbook;
	}
	...
	public static void createTableRows(XSSFSheet sheet,
			Map<Integer, List<ExcelBean>> map, List Objectjs, Class clazz)
			throws IllegalArgumentException, IllegalAccessException,
		...
		for (Object Objectj : Objectjs) {
			...
			for (int i = 0; i < ems.size(); i++) {
				...
				Object rtn = getMethod.invoke(Objectj);
				String value = "";
				if (rtn != null) {  
