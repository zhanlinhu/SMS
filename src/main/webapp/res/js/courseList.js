layui.use(['form','layer','table','laytpl','upload'],function(){
    ...
    function loadCourse() {
      tableIns = table.render({
        ...
        cols : [[
            ...
            {field: "choiceNum", title: "已选（人）",sort:true, minWidth:100, align:"center"},
            {field: "majorName", title: "所属专业", minWidth:100, align:"center"},
    ...
    $(".delAll_btn").click(function(){
        ...
        var data = checkStatus.data, baseCourseIds = "";
        if(data.length > 0) {
            for (var i in data) {
            	baseCourseIds += data[i].id + ",";
            }
            layer.confirm('确定删除选中的用户？', {icon: 3, title: '提示信息'}, function (index) {
            	$.ajax({
            		type: 'get',
            		data: {
            			baseCourseIds : baseCourseIds
            		},
                    dataType: "json",
            		url: url,
            		timeout:2000,
